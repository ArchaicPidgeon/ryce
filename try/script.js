...
(function() {
  var array, editorOptions, format, help, input, load, log, object, output, parse, run, save, say, select, tokenize, translate;
  ...
  //log evt
  //evt.preventDefault()
  vault.set("animals", `animals = array #rabbits #snakes #whales #ducks
